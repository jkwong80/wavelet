...
input_filename_list = ['RebinReadings_2017-04-14T19-55-54Z.h5',\
                       'RebinReadings_2017-04-25T15-32-24Z.h5',\
                       'RebinReadings_2017-04-26T14-29-40Z.h5']

feature_selection_filename ='5b178c11-a4e4-4b19-a925-96f27c49491b__kS_02__kB_16__gap_04__top_features.h5'

input_fullfilename_list = [os.path.join(real_data_root_path, f) for f in input_filename_list]
        ...
        for kB_index, kB in enumerate(kB_list):
            for gap_index, gap in enumerate(gap_list):
                for feature_indices_name_index, feature_indices_name in enumerate(feature_indices_name_list):
                    ...
                    output_fullfilename = os.path.join(real_data_processed_root_path, output_filename)

                    print('**')
                    print(output_filename)
                    print(os.path.join(real_data_processed_root_path, output_filename))
                    print(real_data_processed_root_path)
